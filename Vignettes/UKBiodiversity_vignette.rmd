...
To download you will need to register with the website first, then you can follow the intructions to download the data.
...
install_github("CharlieOuthwaite/UKBiodiversity", quiet = TRUE, force = TRUE)
