...
First, use the `generate_fig1` function to determine the group level average change associated indicator values and the plot of Figure 1.  Then use the `group_trends` function to estimate group and taxa level trends and credible intervals.  The `generate_fig1` function will save csv files of the indicator posterior values, the average annual indicator estimates and associated credible interval values, and a pdf file of the plot within a sub-directory of your specified folder called "geomeans".
